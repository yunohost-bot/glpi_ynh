...
**Shipped version:** 10.0.3~ynh1 *(:warning: This is the `upgrade` branch. The [`master` branch](https://github.com/YunoHost-Apps/glpi_ynh/tree/master) used in the catalog is currently on version 9.5.7\~ynh1.)*
